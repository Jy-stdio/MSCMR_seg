...
if __name__ == '__main__':
    ...
    # 1.3d nii 图像转为 2d 切片
    types = ['C0', 'DE', 'T2']
    # nii_to_npy(r'/home3/HWGroup/zhengyx/JY_file/2_MSCMR_seg/', r'../MSCMR2019/', modal_type=types[1])


    # 3. 数据集增广
    data_augmentation(r'/home3/HWGroup/zhengyx/JY_file/2_MSCMR_seg/2_MSCMR_seg/Pytorch-medical-image-segmentation/MSCMR2019',
                      r'/home3/HWGroup/zhengyx/JY_file/2_MSCMR_seg/2_MSCMR_seg/Pytorch-medical-image-segmentation/', modal_type=types[1])
